      ...
      <div className="relative max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="animate-fade-up">
          ...
          <div className="flex gap-5 mt-10 text-slate-500 dark:text-slate-400">
            ...
            <a href={profile.social.telegram} target="_blank" rel="noopener noreferrer" className="hover:text-accent-light transition-colors" aria-label="Telegram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0Zm5.562 8.16c-.18 1.897-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.064-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23a.24.24 0 0 0-.06-.212c-.07-.058-.164-.038-.234-.022-.1.023-1.688 1.073-4.766 3.15-.451.31-.859.46-1.225.452-.403-.008-1.178-.227-1.756-.415-.707-.23-1.269-.351-1.221-.741.025-.204.307-.413.845-.628 3.311-1.442 5.518-2.393 6.62-2.854 3.153-1.313 3.808-1.541 4.235-1.548.094-.001.303.021.44.131a.47.47 0 0 1 .16.303c.014.086.032.283.017.437Z"/></svg>
           </a>
          </div>
        </div>
